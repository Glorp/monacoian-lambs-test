          ...
          var find = function (tp) {
              return function (t) {
                  var next = function (v) {
                      ...
                      throw new Error("Failed pattern match at Lambs.Term line 48, column 9 - line 48, column 31: " + [ v.constructor.name ]);
                  };
                  var $59 = pred(t);
                  ...
                  if ($59 instanceof Data_Maybe.Just) {
                      return new Data_Maybe.Just(new Found(tp, $59.value0));
                  };
                  throw new Error("Failed pattern match at Lambs.Term line 43, column 7 - line 45, column 36: " + [ $59.constructor.name ]);
              };
          };
      ...
      var halp = function (v1) {
          ...
          if (v1 instanceof Lambs_Term.Lam) {
              return new Lambs_Term.Lam(v1.value0, (function () {
                  ...
                  throw new Error("Failed pattern match at Lambs.Subst line 24, column 29 - line 24, column 61: " + [ $15.constructor.name ]);
              })());
          };
          if (v1 instanceof Lambs_Term.Var) {
              ...
              throw new Error("Failed pattern match at Lambs.Subst line 25, column 20 - line 25, column 54: " + [ $18.constructor.name ]);
          };
          throw new Error("Failed pattern match at Lambs.Subst line 23, column 5 - line 23, column 43: " + [ v1.constructor.name ]);
      };
      ...
      return function (v1) {
          var removeFrom = function (v2) {
              ...
              if (v2 instanceof Data_List_Types.Cons) {
                  ...
                  throw new Error("Failed pattern match at Lambs.Define line 56, column 7 - line 58, column 37: " + [ $33.constructor.name ]);
              };
              throw new Error("Failed pattern match at Lambs.Define line 52, column 1 - line 58, column 37: " + [ v2.constructor.name ]);
          };
      ...
      return function (v1) {
          var addTo = function (v2) {
              ...
              if (v2 instanceof Data_List_Types.Cons) {
                  ...
                  throw new Error("Failed pattern match at Lambs.Define line 47, column 7 - line 49, column 32: " + [ $65.constructor.name ]);
              };
              throw new Error("Failed pattern match at Lambs.Define line 43, column 1 - line 49, column 32: " + [ v2.constructor.name ]);
          };
...
(function(exports) {
  ...
  var run = function (p) {
      return function (x) {
          var $45 = Text_Parsing_Parser.runParser(x)(p);
          if ($45 instanceof Data_Either.Right) {
              return new Data_Either.Right($45.value0);
          };
          if ($45 instanceof Data_Either.Left) {
              return new Data_Either.Left(Text_Parsing_Parser.parseErrorMessage($45.value0) + (" " + Data_Show.show(Text_Parsing_Parser_Pos.showPosition)(Text_Parsing_Parser.parseErrorPosition($45.value0))));
          };
          throw new Error("Failed pattern match at Lambs.Parse line 121, column 3 - line 123, column 79: " + [ $45.constructor.name ]);
      };
  };                                                                                                                                               
  ...
  var many1 = function (p) {
      var halp = function (v) {
          if (v instanceof Data_List_Types.Nil) {
              return Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("expected more than zero somethings");
          };
  ...
  var removeComment = function (s) {
      ...
      var $50 = Text_Parsing_Parser.runParser(s)(remove);
      ...
      throw new Error("Failed pattern match at Lambs.Parse line 156, column 3 - line 158, column 21: " + [ $50.constructor.name ]);
  };
  var letters = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(many1(Text_Parsing_Parser_Token.letter(Data_Identity.monadIdentity)))(function (l) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(listString(l));
  });
  var identifier = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(many1(Text_Parsing_Parser_Token.alphaNum(Data_Identity.monadIdentity)))(function (l) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(listString(l));
  });
  var lam = function (x) {
  ...
  var $$var = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(identifier)(function (s) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Lambs_Term.Var(s));
  });
  ...
  var exp = (function () {
      ...
      var applify = function (v) {
          ...
          throw new Error("Failed pattern match at Lambs.Parse line 77, column 1 - line 84, column 47: " + [ v.constructor.name ]);
      };
  ...
  var number = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(many1(digit))(function (l) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_Foldable.foldl(Data_List_Types.foldableList)(function (res) {
          return function (n) {
              return n + (res * 10 | 0) | 0;
          };
      })(0)(l));
  });
  var idNumSplit = function (str) {
      var p = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(letters)(function (v) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(number)(function (v1) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity))(function (v2) {
                  return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new IdNum(v, v1));
              });
          });
      });
      var $86 = Text_Parsing_Parser.runParser(str)(p);
      if ($86 instanceof Data_Either.Right) {
          return $86.value0;
      };
      if ($86 instanceof Data_Either.Left) {
          return new IdNum(str, 1);
      };
      throw new Error("Failed pattern match at Lambs.Parse line 132, column 3 - line 135, column 3: " + [ $86.constructor.name ]);
  };
  ...
  var parseTop = function (s) {
      var $95 = run(undef)(s);
      if ($95 instanceof Data_Either.Right) {
          return new Data_Either.Right(new Lambs_Toplevel.Undef($95.value0));
      };
      var $97 = run(def)(s);
      if ($97 instanceof Data_Either.Right) {
          return new Data_Either.Right(new Lambs_Toplevel.Def($97.value0));
      };
      var $99 = run(term)(s);
      if ($99 instanceof Data_Either.Right) {
          return new Data_Either.Right(new Lambs_Toplevel.Trm($99.value0));
      };
      if ($99 instanceof Data_Either.Left) {
          return new Data_Either.Left($99.value0);
      };
      throw new Error("Failed pattern match at Lambs.Parse line 150, column 11 - line 152, column 33: " + [ $99.constructor.name ]);
  };
  exports["IdNum"] = IdNum;
  exports["idNumSplit"] = idNumSplit;
...
(function(exports) {
          ...
          var halp = function (__copy_s) {
              return function (__copy_n) {
                  ...
                  tco: while (true) {
                      ...
                      var $32 = Data_Set.member(Data_Ord.ordString)(newId)(used);
                      if ($32) {
                          var __tco_s = s;
                          var __tco_n = n + 1 | 0;
                          s = __tco_s;
                      ...
                      throw new Error("Failed pattern match at Lambs.Eval line 54, column 10 - line 54, column 65: " + [ $32.constructor.name ]);
                  };
              };
          };
          var $33 = Lambs_Parse.idNumSplit(str);
          return halp($33.value0)($33.value1);
      };
  };
  var orElse = function (v) {
      return function (v1) {
      ...
      var free = function (v) {
          return function (bound) {
              if (v instanceof Lambs_Term.Var) {
                  var $62 = Data_Set.member(Data_Ord.ordString)(v.value0)(bound);
                  if ($62) {
                  ...
                  throw new Error("Failed pattern match at Lambs.Eval line 29, column 7 - line 29, column 64: " + [ $62.constructor.name ]);
              };
              ...
              throw new Error("Failed pattern match at Lambs.Eval line 28, column 5 - line 29, column 64: " + [ v.constructor.name, bound.constructor.name ]);
          };
      };
      ...
      return function (v1) {
          return function (v2) {
              if (v2 instanceof Lambs_Term.Lam) {
                  var $71 = v2.value0 !== v && (Data_Set.member(Data_Ord.ordString)(v2.value0)(v1) && Data_Set.member(Data_Ord.ordString)(v)(freeIds(v2.value1)));
                  if ($71) {
                  ...
                  throw new Error("Failed pattern match at Lambs.Eval line 42, column 3 - line 44, column 15: " + [ $71.constructor.name ]);
              };
              return Data_Maybe.Nothing.value;
          };
      };
              ...
              return function (t) {
                  var next = function (v1) {
                      ...
                      if (v1 instanceof Lambs_Term.Lam) {
                          ...
                          throw new Error("Failed pattern match at Lambs.Eval line 77, column 26 - line 77, column 79: " + [ $78.constructor.name ]);
                      };
                      if (v1 instanceof Lambs_Term.App) {
                      ...
                      throw new Error("Failed pattern match at Lambs.Eval line 76, column 9 - line 76, column 31: " + [ v1.constructor.name ]);
                  };
                  var $84 = conflict(v.value1)(argFree)(t);
                  if ($84 instanceof Data_Maybe.Nothing) {
                      return next(t);
                  };
                  if ($84 instanceof Data_Maybe.Just) {
                      return new Data_Maybe.Just(new Lambs_Term.Found(tp, $84.value0));
                  };
                  throw new Error("Failed pattern match at Lambs.Eval line 71, column 7 - line 73, column 36: " + [ $84.constructor.name ]);
              };
          };
  ...
  var allIds = function (v) {
      ...
      throw new Error("Failed pattern match at Lambs.Eval line 34, column 1 - line 34, column 33: " + [ v.constructor.name ]);
  };
  ...
  var stepExec = function (term) {
      ...
      var reduceRename = function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Lambs.Eval line 92, column 5 - line 92, column 76: " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
      var findConf = function (v) {
          return findConflict(freeIds(v.value0))(new Lambs_Subst.Redex(v.value0, v.value1, v.value2));
      };
      var $120 = Lambs_Term.findTerm(Lambs_Subst.redex)(term);
      if ($120 instanceof Data_Maybe.Nothing) {
          return new Normal(term);
      };
      if ($120 instanceof Data_Maybe.Just) {
          return reduceRename(new Lambs_Term.Found($120.value0.value0, $120.value0.value1))(findConf($120.value0.value1));
      };
      throw new Error("Failed pattern match at Lambs.Eval line 83, column 3 - line 85, column 64: " + [ $120.constructor.name ]);
  };
...
(function(exports) {
  ...
  var unparse = function (v) {
      ...
      throw new Error("Failed pattern match at Lambs.Unparse line 17, column 1 - line 17, column 49: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var updateDefs = function (v) {
      return function (d) {
          if (v instanceof Data_Either.Right && v.value0 instanceof Lambs_Toplevel.Undef) {
              return Lambs_Define.removeDef(v.value0.value0)(d);
          };
          if (v instanceof Data_Either.Right && v.value0 instanceof Lambs_Toplevel.Def) {
  ...
  var step1 = function (v) {
      if (v instanceof Data_Either.Right && v.value0 instanceof Lambs_Toplevel.Trm) {
  ...
  var renameDefs = function (d) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main line 55, column 1 - line 55, column 26: " + [ d.constructor.name, v.constructor.name ]);
      };
  };
  var parse = function (s) {
      return Lambs_Parse.parseTop(Lambs_Parse.removeComment(s));
  };
  ...
  var execStr = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 48, column 1 - line 48, column 40: " + [ v.constructor.name ]);
  };
  var step = function (v) {
      if (v instanceof Data_Either.Left) {
          return v.value0;
      ...
      throw new Error("Failed pattern match at Main line 24, column 1 - line 24, column 18: " + [ v.constructor.name ]);
  };
